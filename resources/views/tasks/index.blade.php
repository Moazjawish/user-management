...
<dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
          ...
          <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm/6">
            ...
            <p class="flex-shrink-0 max-w-[95px]  text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-2.5 py-1 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" >{{$task->status}}</p>
